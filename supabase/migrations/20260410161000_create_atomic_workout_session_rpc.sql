CREATE OR REPLACE FUNCTION public.create_workout_session_with_exercises(
  p_student_id UUID,
  p_date DATE,
...
REVOKE ALL ON FUNCTION public.create_workout_session_with_exercises(UUID, DATE, TIME WITHOUT TIME ZONE, TEXT, JSONB) FROM PUBLIC;

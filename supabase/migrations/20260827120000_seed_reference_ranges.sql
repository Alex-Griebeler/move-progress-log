...
values
  ('33f95f17-c617-580f-a87f-b9cc840b0027', 'M', 20, 24, 'Muito Baixo', 0.00, 36.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('387cd383-b165-5073-9d90-3c09f331ed18', 'M', 20, 24, 'Baixo', 36.20, 45.49, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('2e2cc14e-c5c5-55c3-a638-f9870c39fd18', 'M', 20, 24, 'Médio', 45.50, 64.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('9b60de02-15f9-531d-b6c4-3d3c67c4b326', 'M', 20, 24, 'Alto', 64.20, 73.59, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('632b1ebe-1752-55df-8a75-0110475e1545', 'M', 20, 24, 'Muito Alto', 73.60, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('a6b97cd6-ad34-5ce7-a1cf-30998f54d905', 'M', 25, 29, 'Muito Baixo', 0.00, 33.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('2ef4ff74-f434-5d8f-9522-3cac9693ecb3', 'M', 25, 29, 'Baixo', 33.90, 44.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('0716e4d4-a666-5f0d-a5b6-05a66c923908', 'M', 25, 29, 'Médio', 44.40, 65.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('11d8e528-ea3f-556a-9b7b-5f11abb8ac26', 'M', 25, 29, 'Alto', 65.20, 75.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('351a43b3-aa0f-5cde-ae27-677f253058e4', 'M', 25, 29, 'Muito Alto', 75.70, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('0211bcea-9b13-5d85-a950-ba23c85037ef', 'M', 30, 34, 'Muito Baixo', 0.00, 34.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('1b08898a-2764-5294-998f-97252ce917f6', 'M', 30, 34, 'Baixo', 34.90, 45.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('48bd32ea-72e4-582b-b499-0af02dc5edac', 'M', 30, 34, 'Médio', 45.10, 65.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('d10962ca-8cb9-5f86-9918-a55c52f398fd', 'M', 30, 34, 'Alto', 65.40, 75.59, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('67530fff-06a2-5be2-beb6-2c0524034b02', 'M', 30, 34, 'Muito Alto', 75.60, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('c1c57dac-0a4b-5d84-ba56-96b3206cccb8', 'M', 35, 39, 'Muito Baixo', 0.00, 32.49, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('e9718a2f-fcf2-506d-a0c3-2cca7df01890', 'M', 35, 39, 'Baixo', 32.50, 43.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('da497de1-25f4-5ba9-8a6b-c122040f6a5f', 'M', 35, 39, 'Médio', 43.40, 65.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('f213df58-2b37-5fe6-b04d-737cbf1acda4', 'M', 35, 39, 'Alto', 65.20, 76.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('61b35477-3a80-597d-882f-8f47b01963d4', 'M', 35, 39, 'Muito Alto', 76.10, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('e7220802-7b73-5512-95a5-95e3fca07412', 'M', 40, 44, 'Muito Baixo', 0.00, 34.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('abeb02b8-d423-56d8-ae1b-699f2788412a', 'M', 40, 44, 'Baixo', 34.20, 43.59, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('64695356-2511-55bd-b092-b73096d2df59', 'M', 40, 44, 'Médio', 43.60, 62.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('493b1433-9b10-5fcc-a1bd-8b383225bcd4', 'M', 40, 44, 'Alto', 62.40, 71.79, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('c2609c3f-2c67-561c-bdbe-f4c07929be16', 'M', 40, 44, 'Muito Alto', 71.80, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('cec18e62-352d-5cbe-83b0-638ee053f242', 'M', 45, 49, 'Muito Baixo', 0.00, 28.99, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('63dde9b4-df30-5896-9d78-87ed7152519a', 'M', 45, 49, 'Baixo', 29.00, 39.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('89963208-6dd8-5643-9e3f-40df9dbef1a6', 'M', 45, 49, 'Médio', 39.40, 60.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('bfd50df3-dde5-5b4e-bb35-95099b287150', 'M', 45, 49, 'Alto', 60.30, 70.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('2fdb95cc-2618-5e5d-815b-0ffa968e1270', 'M', 45, 49, 'Muito Alto', 70.70, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('3f4571b3-807a-5ed3-8450-87b00c22ccc0', 'M', 50, 54, 'Muito Baixo', 0.00, 35.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('8d51d0b1-a42e-58b2-bc71-6fd425bdd273', 'M', 50, 54, 'Baixo', 35.10, 43.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('2c62710a-4208-5c0b-8674-0adb9358e8ff', 'M', 50, 54, 'Médio', 43.30, 59.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('ba1f04a9-521e-55df-b59b-6d86e8369c18', 'M', 50, 54, 'Alto', 59.70, 67.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('c4a8fc32-373b-576a-99eb-8d8207bba0df', 'M', 50, 54, 'Muito Alto', 67.90, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('efbce8bb-a177-51d9-aa26-7286516b9cfa', 'M', 55, 59, 'Muito Baixo', 0.00, 21.59, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('d4cb9912-d224-5824-82cf-c13945d68327', 'M', 55, 59, 'Baixo', 21.60, 33.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('42a5f8a7-aa23-5cdc-8805-44880cdaf8fd', 'M', 55, 59, 'Médio', 33.70, 57.99, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('566e1963-d22d-524f-b025-ede68091a1f7', 'M', 55, 59, 'Alto', 58.00, 70.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('f0251476-607a-5f3a-88c3-4fdba3984b71', 'M', 55, 59, 'Muito Alto', 70.10, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('2a829306-b2c2-5ac5-a1ab-369173593ee4', 'M', 60, 64, 'Muito Baixo', 0.00, 22.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('59745f85-3ad5-58c0-8272-e9b1fab6efc9', 'M', 60, 64, 'Baixo', 22.20, 31.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('27c3cf8a-cb89-5033-8b6e-b03fe1c958d2', 'M', 60, 64, 'Médio', 31.40, 49.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('4ce83d56-95ed-5c99-9225-4191cb5752e5', 'M', 60, 64, 'Alto', 49.90, 59.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('86a80b88-01db-5290-ae53-e956b30f8bf4', 'M', 60, 64, 'Muito Alto', 59.20, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('76bf893a-cb7a-5268-baf9-da7e47db956d', 'M', 65, 69, 'Muito Baixo', 0.00, 22.59, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('dcf631cf-6a15-5814-93db-ffd7294bc00e', 'M', 65, 69, 'Baixo', 22.60, 31.99, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('38b64f89-cc0f-57d6-a2cd-f08f5c51519c', 'M', 65, 69, 'Médio', 32.00, 50.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('ce049804-df6b-5d75-8524-2fed9959e1d3', 'M', 65, 69, 'Alto', 50.70, 59.99, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('dfe5043c-c7bf-55bb-9080-222a06c1ec5b', 'M', 65, 69, 'Muito Alto', 60.00, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('428faa6f-8504-5410-ad1a-7b40f4733e2b', 'M', 70, 74, 'Muito Baixo', 0.00, 14.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('2249d2d2-7e26-557b-9123-c9ad15b9db2f', 'M', 70, 74, 'Baixo', 14.70, 24.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('adc5b5af-64f3-53f4-afe5-d5f83de5d10c', 'M', 70, 74, 'Médio', 24.40, 43.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('b13c1cc9-dad3-5412-8c06-c3a999adbdbe', 'M', 70, 74, 'Alto', 43.90, 53.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('042646d1-d0b0-54cc-b31d-978d8d29d9e2', 'M', 70, 74, 'Muito Alto', 53.70, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('c0c1f07a-a72e-5a89-aa82-4309dabf2369', 'M', 75, 99, 'Muito Baixo', 0.00, 10.79, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('211b9f7c-64cf-5032-9dc7-fd9c8d804b8d', 'M', 75, 99, 'Baixo', 10.80, 20.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('4aac9826-dc81-5caf-b3be-51e034b2ffaf', 'M', 75, 99, 'Médio', 20.30, 39.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('1c471fcb-c988-5437-af93-290e61ac1b28', 'M', 75, 99, 'Alto', 39.30, 48.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('334501a0-8d38-5206-8fc1-04b5f1e4ccd8', 'M', 75, 99, 'Muito Alto', 48.90, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('88967a2e-5c5c-58ae-9aaf-6deddd219392', 'F', 20, 24, 'Muito Baixo', 0.00, 18.79, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('8d9c05c2-fd8c-559c-b7ac-31f79bd58946', 'F', 20, 24, 'Baixo', 18.80, 25.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('73035116-419c-591e-b314-f25f7c1573f5', 'F', 20, 24, 'Médio', 25.40, 38.49, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('f63ceb78-0f82-5bef-89a5-4c87db1bdea6', 'F', 20, 24, 'Alto', 38.50, 45.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('ec21fa5c-2586-5f6a-829c-0e5d07aede55', 'F', 20, 24, 'Muito Alto', 45.10, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('6bb9ccc9-8ee5-53ad-89fe-f50cdafa9491', 'F', 25, 29, 'Muito Baixo', 0.00, 21.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('69de5897-cac8-51f5-8857-4c80be157911', 'F', 25, 29, 'Baixo', 21.20, 27.49, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('e02e1136-91da-5a54-b6a0-bccbb7c5abde', 'F', 25, 29, 'Médio', 27.50, 40.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('b15fb244-afc1-555b-a50a-f31b33cb912a', 'F', 25, 29, 'Alto', 40.10, 46.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('4010dedc-d03f-5894-85f8-04b30a9fdae3', 'F', 25, 29, 'Muito Alto', 46.40, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('536f950b-c798-5f62-b050-0c6e39397c71', 'F', 30, 34, 'Muito Baixo', 0.00, 18.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('590f513e-a194-54ea-9dd9-68d2df1f7edb', 'F', 30, 34, 'Baixo', 18.30, 26.99, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('38b4cb4c-1323-5ac9-963d-92c0b4dace7e', 'F', 30, 34, 'Médio', 27.00, 44.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('1c336800-3911-5276-b50f-8c8ab54d6fa8', 'F', 30, 34, 'Alto', 44.40, 53.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('da544e48-c81d-5e6a-959a-dbd92adf0516', 'F', 30, 34, 'Muito Alto', 53.10, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('9ab9afd5-07ad-559f-8fc3-25152c50c406', 'F', 35, 39, 'Muito Baixo', 0.00, 23.79, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('1b770af7-92f3-5797-a8ab-52801f031f0f', 'F', 35, 39, 'Baixo', 23.80, 28.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('08a5593b-effe-5f09-ab59-ac5c3a8fb0ea', 'F', 35, 39, 'Médio', 28.70, 38.49, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('6cec3a3c-e3a4-57fa-baed-99ce62c4e085', 'F', 35, 39, 'Alto', 38.50, 43.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('422c2c86-3e4b-55e4-8b19-919e12ea6e34', 'F', 35, 39, 'Muito Alto', 43.40, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('4a1e88c5-e8ee-50a2-b5e3-272af7b3012f', 'F', 40, 44, 'Muito Baixo', 0.00, 19.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('f630fd18-1bf0-5351-bfd9-39d1d40c5833', 'F', 40, 44, 'Baixo', 19.70, 25.79, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('e8ae0e68-00e6-56bb-8620-575f7486e552', 'F', 40, 44, 'Médio', 25.80, 38.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('fdd96f6c-277b-5783-b7ce-529c9bc823e8', 'F', 40, 44, 'Alto', 38.10, 44.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('8a1bea22-246e-544f-abb5-dc1ac256751c', 'F', 40, 44, 'Muito Alto', 44.20, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('f0e531e6-25ee-5bc0-ac06-6f861cce067f', 'F', 45, 49, 'Muito Baixo', 0.00, 14.49, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('e43c4d35-6e47-5ebd-a287-98dedf0e15ec', 'F', 45, 49, 'Baixo', 14.50, 21.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('ea790c5a-a974-52a7-9f60-d03b9402cd2c', 'F', 45, 49, 'Médio', 21.40, 35.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('b689e5b5-0786-5773-be09-17c38e7074df', 'F', 45, 49, 'Alto', 35.10, 41.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('7ee919ef-bcbd-5ec5-bcb3-76dd04a0a4ae', 'F', 45, 49, 'Muito Alto', 41.90, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('d534c4ba-6f2b-503a-b9c4-e5e1336741a7', 'F', 50, 54, 'Muito Baixo', 0.00, 19.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('da5f163c-c20b-5427-92c8-ed8ec417bd65', 'F', 50, 54, 'Baixo', 19.30, 24.59, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('20fe85df-05ca-5280-ba4a-37bbfbaa3f48', 'F', 50, 54, 'Médio', 24.60, 35.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('d7a6db43-2440-537f-83b8-d79862521bf9', 'F', 50, 54, 'Alto', 35.10, 40.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('a566237d-b26a-53b2-9e2b-9a6c736aaaf0', 'F', 50, 54, 'Muito Alto', 40.40, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('5c5d7992-dd7b-5399-b548-8f3ab8095d91', 'F', 55, 59, 'Muito Baixo', 0.00, 14.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('fdbce746-315f-5229-8930-0880f2fde783', 'F', 55, 59, 'Baixo', 14.70, 20.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('fa27d6f4-6415-55d5-8d89-133f3b4a4775', 'F', 55, 59, 'Médio', 20.30, 31.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('794e3def-fddf-5054-89c3-5859f3dba57f', 'F', 55, 59, 'Alto', 31.70, 37.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('9f365f8a-0c10-5ea7-b58f-4b35f9a99542', 'F', 55, 59, 'Muito Alto', 37.30, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('ede6380d-b324-54d9-bd89-d12536ab1470', 'F', 60, 64, 'Muito Baixo', 0.00, 15.79, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('44023e27-7436-52be-af06-d3825f5be7af', 'F', 60, 64, 'Baixo', 15.80, 20.39, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('0f23e4ad-f399-524e-8061-dce065ee39a9', 'F', 60, 64, 'Médio', 20.40, 29.59, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('fce8ef26-e163-5c4a-88c5-d5c23e461db1', 'F', 60, 64, 'Alto', 29.60, 34.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('9ad573eb-0b2b-5906-953e-8b93a7051735', 'F', 60, 64, 'Muito Alto', 34.20, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('c900b506-3679-52a8-85b3-643c677cc2f4', 'F', 65, 69, 'Muito Baixo', 0.00, 13.69, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('5d2907ce-bc27-5434-afb1-4fc7dbb05abc', 'F', 65, 69, 'Baixo', 13.70, 18.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('4ce516fa-7b9c-5ff8-8ce9-b7ad8c7895aa', 'F', 65, 69, 'Médio', 18.10, 26.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('1b65b78d-f4f6-546a-86ad-e78749d6e776', 'F', 65, 69, 'Alto', 26.90, 31.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('b757b093-fac2-55c0-bd9c-8ac379f3bfb8', 'F', 65, 69, 'Muito Alto', 31.30, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('002c9aee-5944-5d57-9518-23a38d4a9462', 'F', 70, 74, 'Muito Baixo', 0.00, 11.89, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('64d867b6-3bcc-5aff-9f8d-d7d286819e5c', 'F', 70, 74, 'Baixo', 11.90, 17.19, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('e2aecc4e-c47e-5beb-a2a9-ccbfeee0e1d1', 'F', 70, 74, 'Médio', 17.20, 27.79, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('412d0eef-8885-52b6-9d7b-d43bd32ef96a', 'F', 70, 74, 'Alto', 27.80, 33.09, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('bd59c33d-9e3b-5de4-87d2-102896e2cc1b', 'F', 70, 74, 'Muito Alto', 33.10, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('dc228cab-e579-5793-9e62-c10fccf96041', 'F', 75, 99, 'Muito Baixo', 0.00, 9.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('09597e54-7164-51e9-b57d-bda5bbd00f5b', 'F', 75, 99, 'Baixo', 9.30, 14.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('f8f934f7-8c04-5420-9c03-d83bc3e0afe8', 'F', 75, 99, 'Médio', 14.30, 24.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('5b07d9bc-896a-553b-a21c-da962c37d35e', 'F', 75, 99, 'Alto', 24.30, 29.29, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)'),
  ('39d66adf-31bc-5854-b546-22cd763daa7c', 'F', 75, 99, 'Muito Alto', 29.30, 150.00, 'Derivação Fabrik (bandas z-score) sobre Mathiowetz 1985 (Arch Phys Med Rehabil 66:69-72; mão DIREITA)')
on conflict (id) do nothing;

-- Fix primary_muscles (Leva 3b): correção biomecânica de arremessos + ativações escapular/glútea + hinge/no-primary.
-- Auditado por Codex (consenso 2026-07-16). Coluna é text[] → ARRAY[...]::text[]. Idempotente (IS DISTINCT FROM). Casa por id8+nome.
...
UPDATE public.exercises_library SET primary_muscles = ARRAY['gluteo_medio','gluteo','core']::text[]
WHERE left(id::text,8) = '89b62aa6' AND name = 'Airplane' AND primary_muscles IS DISTINCT FROM ARRAY['gluteo_medio','gluteo','core']::text[];
UPDATE public.exercises_library SET primary_muscles = ARRAY['gluteo_medio','gluteo']::text[]
WHERE left(id::text,8) = 'dc2e0943' AND name = 'Clam Shell' AND primary_muscles IS DISTINCT FROM ARRAY['gluteo_medio','gluteo']::text[];
UPDATE public.exercises_library SET primary_muscles = ARRAY['gluteo','isquiotibial']::text[]
WHERE left(id::text,8) = 'e7200508' AND name = 'Extensão Quadril Quadrupede' AND primary_muscles IS DISTINCT FROM ARRAY['gluteo','isquiotibial']::text[];
UPDATE public.exercises_library SET primary_muscles = ARRAY['gluteo','isquiotibial']::text[]
WHERE left(id::text,8) = '07fdea96' AND name = 'Flex-Ext Quadril decúbito dorsal com medicine ball' AND primary_muscles IS DISTINCT FROM ARRAY['gluteo','isquiotibial']::text[];
UPDATE public.exercises_library SET primary_muscles = ARRAY['gluteo_medio','gluteo']::text[]
...
UPDATE public.exercises_library SET primary_muscles = ARRAY['gluteo','isquiotibial','gluteo_medio']::text[]
WHERE left(id::text,8) = '326740cf' AND name = 'Ponte unilateral 1 joelho estendido' AND primary_muscles IS DISTINCT FROM ARRAY['gluteo','isquiotibial','gluteo_medio']::text[];
UPDATE public.exercises_library SET primary_muscles = ARRAY['gluteo','isquiotibial','gluteo_medio']::text[]
WHERE left(id::text,8) = '7da433cf' AND name = 'Ponte unilateral joelhos flexionados' AND primary_muscles IS DISTINCT FROM ARRAY['gluteo','isquiotibial','gluteo_medio']::text[];
UPDATE public.exercises_library SET primary_muscles = ARRAY['gluteo','isquiotibial','gluteo_medio']::text[]
WHERE left(id::text,8) = '221c9d07' AND name = 'Ponte unilateral joelhos flexionados isométrica' AND primary_muscles IS DISTINCT FROM ARRAY['gluteo','isquiotibial','gluteo_medio']::text[];

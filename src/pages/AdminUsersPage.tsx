...
export default function AdminUsersPage() {
  ...
  const statsDescription = loading 
    ? "Carregando informações..."
    : `${stats.total} usuários cadastrados (${stats.admins} ${stats.admins === 1 ? 'administrador' : 'administradores'}, ${stats.moderators} ${stats.moderators === 1 ? 'treinador' : 'treinadores'}, ${stats.users} ${stats.users === 1 ? 'aluno' : 'alunos'})`;
  ...
  return (
    <PageLayout>
      <PageHeader
        ...
        breadcrumbs={[
          { label: NAV_LABELS.adminUsers, icon: Users }
        ]}
        actions={

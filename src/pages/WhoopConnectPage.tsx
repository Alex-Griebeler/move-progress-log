      ...
      <PublicPageShell centered>
        <Card>
          <CardHeader>
            ...
            <CardDescription>{error || "Este link é inválido, expirou ou já foi usado."}</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-body-sm text-muted-foreground">Peça um novo link à equipe da Fabrik.</p>
          </CardContent>
        </Card>
      </PublicPageShell>
    );
      ...
      <PublicPageShell centered>
        <Card>
          <CardHeader className="text-center space-y-sm">
            ...
            <CardTitle className="text-h2">Whoop já conectado</CardTitle>
            <CardDescription>
              A autorização foi recebida. A equipe da Fabrik já acompanha os dados do Whoop.
            </CardDescription>
          </CardHeader>
          <CardContent>
    ...
    <PublicPageShell>
      <Card>
        <CardHeader className="text-center space-y-sm">
          ...
          <CardTitle className="text-h2">Conectar Whoop</CardTitle>
          <CardDescription className="text-body-sm">
            {inviteData.trainer_name}, da Fabrik, pediu acesso aos dados do seu Whoop para ajustar os treinos.
          </CardDescription>
        </CardHeader>
          ...
          <div className="bg-muted/50 p-4 rounded-lg space-y-3">
            ...
            <ul className="grid grid-cols-1 gap-2">
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>Recuperação (VFC, FC em repouso)</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Moon className="h-4 w-4 text-primary" aria-hidden="true" />
                <span>Sono (desempenho, fases, eficiência)</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Activity className="h-4 w-4 text-primary" aria-hidden="true" />
                <span>Esforço diário e treinos</span>
              </li>
            </ul>
          </div>

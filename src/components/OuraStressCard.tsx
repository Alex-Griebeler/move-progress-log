  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        {totalTime > 0 && (
          <div className="p-lg rounded-lg bg-card border">
            <div className="flex items-center justify-between mb-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-md p-md rounded-lg bg-destructive/10 border border-destructive/20">
          ...
          <div className="flex items-center gap-md p-md rounded-lg bg-chart-3/10 border border-chart-3/20">
        ...
        {metrics.recovery_high_time !== null && metrics.recovery_high_time > 14400 && (
          <div className="p-md bg-primary/10 border border-primary/20 rounded-lg">
